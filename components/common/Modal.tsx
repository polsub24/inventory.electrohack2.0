...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, footer }) => {
    ...
    return (
        ...
        >
            <div
                className="bg-gray-950 border border-amber-900/50 rounded-lg shadow-[0_0_50px_rgba(212,175,55,0.1)] w-full max-w-lg max-h-[90vh] flex flex-col transform transition-all duration-300 scale-100 overflow-hidden"
