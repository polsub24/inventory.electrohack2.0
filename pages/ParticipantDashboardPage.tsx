...
const ParticipantDashboardPage: React.FC = () => {
  ...
  const TabButton: React.FC<{tab: 'store' | 'requests', label: string}> = ({ tab, label }) => (
    <button
        ...
        className={`flex-1 py-4 px-4 sm:px-8 font-black text-xs sm:text-sm uppercase tracking-widest transition-all duration-200 focus:outline-none border-b-2 ${
            activeTab === tab
      ...
      <div className="mb-6 sm:mb-10">
        ...
        <div className="border-b border-gray-800">
            <nav className="flex" aria-label="Tabs">
                <TabButton tab="store" label="Inventory" />
