...
const AdminDashboardPage: React.FC = () => {
  ...
  const TabButton: React.FC<{tab: 'active' | 'approved' | 'released' | 'inventory', label: string}> = ({ tab, label }) => (
    <button
        ...
        className={`whitespace-nowrap py-4 px-6 sm:px-10 font-black text-xs sm:text-sm uppercase tracking-widest transition-all duration-200 focus:outline-none border-b-2 ${
            activeTab === tab
