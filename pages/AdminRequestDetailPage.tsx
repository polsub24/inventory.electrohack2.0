...
const AdminRequestDetailPage: React.FC = () => {
  ...
  if (!request) {
    return (
      <div className="text-center py-10">
        ...
        <Link to="/admin" className="mt-4 inline-block text-emerald-400 hover:text-emerald-300 font-bold uppercase text-xs tracking-widest">
  ...
  return (
    <div>
       <Link to="/admin" className="mb-8 inline-flex items-center text-gray-500 hover:text-emerald-400 transition-colors uppercase text-xs font-black tracking-widest">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-black text-emerald-400 uppercase italic tracking-tighter">Request Management</h1>
